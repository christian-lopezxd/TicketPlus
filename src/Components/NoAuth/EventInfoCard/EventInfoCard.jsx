...
const EventInfoCard = (props) => { 
  return (
    ...
    <div className="flex justify-end gap-2">
            ...
            <NavLink to={`/login`}> <button className="flex flex-row items-center gap-2 bg-newblue hover:bg-darkblue py-4 px-4 rounded font-montserrat text-white font-normal py-1 px-3 "><ImTicket />Buy Tickets</button> </NavLink>
